@echo off
REM Copyright (C) 2024 The Android Open Source Project
REM
...
:init
REM TODO(b/329887683): reuse existing apksigner.bat script (this is the only difference)
set jarfile=apksigner-kms.jar
